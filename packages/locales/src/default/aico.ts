export default {
  ...
  'errors.DIRECT_PROVIDER_NOT_ALLOWED':
    'Direct providers are not available. Use a {{brandName}} model — usage is billed from your wallet.',
  ...
  'org.noModelsGranted': 'No models granted',
  'org.suspendedBanner':
    'This organization is suspended. Dashboard views are read-only until a platform admin reactivates it.',
  'org.suspendedTag': 'Suspended',
  'org.allocateFailed': 'Allocation failed',
  'org.allocateHint':
    'Set a recurring USD spending cap for this member. Unused balance does not roll over at renewal. Period changes apply at the next reset boundary.',
  ...
  'org.allocatePeriodChangeWarn':
    'This member already has a {{current}} budget. Changing to {{next}} queues the new cap for the next renewal; funds are reserved now.',
  'org.allocateSubmit': 'Set member budget',
  'org.allocateSuccess': 'Member budget updated (managed key synced)',
  'org.allocateTitle': 'Set USD period budget for member',
  'org.amountToman': 'Amount (toman)',
  'org.amountUsd': 'Period cap (USD)',
  'org.assignTeam': 'Assign team',
  'org.columns.actions': 'Actions',
  'org.columns.default': 'Default',
  'org.columns.email': 'Email',
  'org.columns.limit': 'Limit',
  'org.columns.models': 'Models',
  'org.columns.nextRenewal': 'Next renewal',
  'org.columns.pending': 'Pending',
  'org.columns.period': 'Period',
  'org.columns.publicId': 'Public ID',
  'org.columns.remaining': 'Remaining',
  'org.columns.renewalStatus': 'Renewal',
  ...
  'org.columns.username': 'Username',
  'org.columns.value': 'Value',
  'org.period.daily': 'Daily',
  'org.period.weekly': 'Weekly',
  'org.period.monthly': 'Monthly',
  'org.period.total': 'No expiry (legacy)',
  'org.period.nextBoundary': 'Next UTC reset (local time): {{time}}',
  ...
  'org.invite.linkClose': 'Close',
  'org.invite.linkCopied': 'Invite link copied',
  'org.invite.linkTitle': 'Share invite link',
  ...
  'org.modelIds': 'Allowed models (search and select; empty = no models on org wallet)',
  'org.modelIdsPlaceholder': 'Type to search models…',
  ...
  'org.sweep.balanceChange': 'Org wallet: {{before}} → {{after}}',
  'org.sweep.cancel': 'Cancel',
  'org.sweep.cardHint':
    'Returns every remaining member allowance to the org wallet, stops their recurring charges, and sets each limit to zero. Members can be given new budgets afterwards. Personal wallets are not affected.',
  'org.sweep.cardTitle': 'Reclaim all member credit',
  'org.sweep.columns.limit': 'Limit',
  'org.sweep.columns.member': 'Member',
  'org.sweep.columns.note': 'Note',
  'org.sweep.columns.outcome': 'Outcome',
  'org.sweep.columns.period': 'Period',
  'org.sweep.columns.reclaimed': 'Reclaimed',
  'org.sweep.columns.toReclaim': 'To reclaim',
  'org.sweep.columns.used': 'Used',
  'org.sweep.confirmLabel': 'Type “{{name}}” to confirm',
  'org.sweep.deferredNotice':
    '{{count}} member(s) could not be settled right now and were queued for automatic retry. Their credit will land in the wallet shortly.',
  'org.sweep.description':
    'Review what will be returned to the organization wallet before running the sweep. Nothing is charged or disabled until you confirm.',
  'org.sweep.done': 'Done',
  'org.sweep.loading': 'Calculating remaining credit…',
  'org.sweep.newOrgBalance': 'Org wallet is now {{balance}}.',
  'org.sweep.nothingToReclaim': 'There is no member credit left to reclaim.',
  'org.sweep.open': 'Reclaim all member credit',
  'org.sweep.outcome.deferred': 'Queued for retry',
  'org.sweep.outcome.reclaimed': 'Reclaimed',
  'org.sweep.outcome.skipped': 'Nothing to reclaim',
  'org.sweep.skipReason.already-settled': 'Already reclaimed',
  'org.sweep.skipReason.no-budget': 'No budget',
  'org.sweep.source.walletFallback': 'Estimate — provider unreachable',
  'org.sweep.source.walletOnly': 'No managed key',
  'org.sweep.submit': 'Reclaim all credit',
  'org.sweep.title': 'Reclaim all member credit',
  'org.sweep.totalReclaimed': 'Total reclaimed',
  'org.sweep.totalToReclaim': 'Total to reclaim',
  'org.sweep.warningBody':
    'Every member listed above loses their remaining allowance and stops being charged. Usage history and the wallet statement are kept.',
  'org.sweep.warningTitle': 'This affects every member at once',
  ...
  'org.usageChart': 'Usage over time',
  'org.usageChartHint': 'Daily spend from usage logs in the selected UTC date range.',
  'org.usageEmpty': 'No usage in this date range yet.',
  'org.usageMemberAll': 'All members',
  'org.usageMemberFilter': 'Member',
  'org.usageRange': 'Date range',
  'org.usageSpend': 'Spend (USD)',
  'org.txEmpty': 'No wallet transactions in this date range.',
  'org.txTitle': 'Wallet statement',
  ...
  'platform.columns.username': 'Username',
  ...
  'platform.creditUserAction': 'Allocate credit',
  'platform.deactivateUser': 'Deactivate user',
  'platform.reactivateUser': 'Reactivate user',
  'platform.deactivateReason': 'Reason (shown on login)',
  'platform.deactivateReasonRequired': 'Enter a reason for deactivation',
  'platform.deactivateConfirm': 'Deactivate this user? They will not be able to sign in.',
  'platform.deactivateSuccess': 'User deactivated',
  'platform.reactivateSuccess': 'User reactivated',
  'platform.userBanned': 'Deactivated',
  ...
  'platform.manualCreditHint': 'Credits org USD wallet at the admin FX rate.',
  'platform.manualUserCredit': 'Manual user credit',
  'platform.manualUserCreditHint':
    'Credits a B2C user USD wallet at the admin FX rate. Provide email and/or select a wallet user.',
  'platform.fxTitle': 'Exchange rate',
  'platform.fxLabel': 'Toman per 1 USD',
  'platform.fxHint': 'Used for all credits and toman↔USD conversions. Source: {{source}}.',
  'platform.fxSave': 'Save rate',
  ...
  'platform.multiplierHint':
    'Applied to every model price and to usage billed against wallets. One value per upstream provider, shared by all users — it takes effect for new requests only and never reprices past usage.',
  ...
  'platform.modelMultiplierHint':
    'Providers publish a cost coefficient per model, but do not always charge it. An override corrects the price shown in the model picker and the per-message cost. It does not change what is debited from a wallet — that is measured from real upstream spend.',
  'platform.modelMultiplierModel': 'Model',
  'platform.modelMultiplierPublished': 'Published',
  'platform.modelMultiplierEffective': 'Override',
  'platform.modelMultiplierNoOverride': 'None',
  'platform.modelMultiplierEdit': 'Set coefficient',
  'platform.modelMultiplierLabel': 'Coefficient',
  'platform.modelMultiplierSave': 'Save',
  'platform.modelMultiplierResetAction': 'Reset',
  ...
  'platform.modelsHint':
    'The managed model list is refreshed daily. Use manual fetch to update immediately.',
  ...
  'platform.modelsSyncFailed': 'Failed to sync models',
  'platform.modelsSynced': 'Models synced',
  'platform.modelsTitle': 'Model catalog',
  'platform.modelsHistory': 'Sync history',
  'platform.modelsAdded': 'Added ({{count}})',
  'platform.modelsRemoved': 'Removed ({{count}})',
  'platform.modelsNoDiff': 'No model changes',
  'platform.modelsHistoryEmpty': 'No sync runs yet',
  'platform.openRouter': 'Master provider balance',

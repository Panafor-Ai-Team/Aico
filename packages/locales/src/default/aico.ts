export default {
  ...
  'org.allocateTitle': 'Set π period budget for member',
  'org.amountToman': 'Amount (toman)',
  'org.amountPi': 'Period cap (π)',
  ...
  'org.upgradeDesc':
    'Upgrade to a company account to invite members, split π credits, and control model access by team. Requires a verified phone.',
  ...
  'platform.multiplierTitle': 'Top-up yield',
  'platform.multiplierLabel': 'Multiplier',
  'platform.multiplierHint':
    'Applied only when credits are added: $1 buys fewer π (margin). Model prices and usage are shown in π at raw CVC rates — one value per upstream provider.',
  'platform.multiplierSave': 'Save yield',
  'platform.multiplierSaved': 'Top-up yield updated',
  'platform.multiplierFailed': 'Failed to update top-up yield',
  ...
  'wallet.fxHintPi': '$1 = {{pi}} π ≈ {{rate}} toman',
  'wallet.previewPi': 'You receive: {{pi}}',
  ...
  'wallet.remainingPi': 'Remaining (π)',
  'wallet.remainingToman': 'Remaining (toman)',
  'wallet.remainingUnknown': '—',
  'wallet.remainingUsd': 'Remaining (USD)',
  'wallet.subtitle': 'Your π token wallet. Managed keys stay server-side.',

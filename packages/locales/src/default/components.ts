export default {
  ...
  'ModelSwitchPanel.detail.pricing.credits.cachedInput': 'Cached input {{amount}} π/M tokens',
  ...
  'ModelSwitchPanel.detail.pricing.credits.megapixel': 'π/MP',
  'ModelSwitchPanel.detail.pricing.credits.millionCharacters': 'π/M chars',

export default {
  ...
  'ampInstallGuide.reason': '{{appName}} could not start Amp: {{message}}',
  ...
  'claudeCodeInstallGuide.reason': '{{appName}} could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': '{{appName}} could not start Codex: {{message}}',
  ...
  'opencodeInstallGuide.reason': '{{appName}} could not start OpenCode: {{message}}',
  ...
  'gatewayMode.desc':
    "Run agents in the cloud through {{appName}}'s Agent Gateway. Tasks keep running even after you close the page.",
  ...
  'plus.search.appSearchDesc':
    '{{appName}} optimized search service, delivering best retrieval results.',
  ...
  'sharePage.menu.goTo{{appName}}': 'Go to {{appName}}',

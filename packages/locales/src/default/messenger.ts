export default {
  ...
  'messenger.detail.commands.feedback':
    'Send feedback to the {{appName}} team (no AI reply), e.g. /feedback your message',
  ...
  'messenger.detail.commands.start': 'Link your account to {{appName}}',
  ...
  'messenger.slack.installBlocked.suggestion':
    "DM @{{appName}} on Slack to link your personal account — you don't need to install again. Or ask the original installer to disconnect this workspace first if you want to take over ownership.",
  ...
  'messenger.discord.installBlocked.suggestion':
    "DM the {{appName}} bot on Discord to link your personal account — you don't need to add the bot again. Or ask the original installer to remove this server in {{appName}} Settings → Messenger before re-adding it.",
  ...
  'messenger.list.discord.description':
    'Chat with your {{appName}} agents on Discord by DMing the {{appName}} bot from any server.',
  'messenger.list.slack.description':
    'Chat with your {{appName}} agents on Slack by DMing or mentioning @{{appName}} in any workspace.',
  ...
  'messenger.list.wechat.description':
    'Scan with WeChat to chat privately with your {{appName}} agents and switch agents with /agents.',
  ...
  'messenger.unlinkConfirmWechat':
    'Disconnect your WeChat account from {{appName}}? Inbound messages will stop until you scan the QR code to reconnect.',
  ...
  'messenger.wechat.error.alreadyLinkedToOther':
    'This WeChat account is already connected to another {{appName}} account.',
